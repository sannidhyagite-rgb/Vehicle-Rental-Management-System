    ...
    <div className="vendor-page-shell">
      <div className="vendor-container">
        ...
        <div className="filters-card">
          <input placeholder="Search vehicles..." className="search-input" />
          <select className="select"> <option>All Status</option> <option>Available</option> <option>Rented</option> </select>
          <select className="select"> <option>All Types</option> <option>SUV</option> <option>Electric</option> </select>
        </div>
